...
(1)StellaQL/StellaQL_Work フォルダーを、あなたの
Unityプロジェクト・フォルダーの直下に置いてください。

(2)StellaQL/Assets/StellaQL フォルダーを、あなたの Assetsフォルダーの直下に
置いてください。
...
(3)Unityのメニューから[Window] - [State Machine Query (StellaQL)]を選び、
...
(6)[Generate C# (Fullpath of states)]ボタンを押してください。
...
(7)さきほどの(2)で移動させた StellaQLUserSettings.cs ファイルを開いてください。
...
(8)Assets/StellaQL/チュートリアル.txt にはチュートリアルを用意しました。
クエリーの実行方法はそちらを参照してください。

Assets/StellaQL/コマンドリファレンス.txt には利用できるクエリーの機能を
一覧しました。

また、StellaQL/StellaQL_Work/StellaQL_MacroApplication.ods ファイルは
