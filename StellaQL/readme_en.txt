...
(1) StellaQL/StellaQL_Work folder, your
Please put it under the Unity project folder.

(2) Place the StellaQL/Assets/StellaQL folder directly under your Assets folder
please leave it.
...
(3) Select [Window] - [State Machine Query (StellaQL)] from the Unity menu,
Please dock the StateMachineQueryStellaQL window.

(4) Assets/StellaQL/MayBeDeletedThisFolder/AnimatorControllers/Demo_Zoo
Please open the file.
(It is not the C# script, but the animator controller)

(5) Also, Demo_Zoo animator controller,
...
(6) Press the Generate C# (Fullpath of states) button.
...
(7) Please open the StellaQLUserSettings.cs file you moved in (2) before.
...
(8) Assets/StellaQL/チュートリアル.txt has prepared a tutorial.
For how to execute the query, please refer to that.

Assets/StellaQL/Command Reference. Txt contains the available query functions
Listed.

Also, the StellaQL/StellaQL_Work/StellaQL_MacroApplication.ods file
